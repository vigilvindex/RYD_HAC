...
if ((_ammo > 0) and not (_busy)) then
	...
	if ((RydHQF_Debug) or (isPlayer (leader _unitG))) then 
		{
		_i1 = [[_posXWP1,_posYWP1],_unitG,"markSFFlank1","ColorOrange","ICON","DOT","SF1 F"," - SF FLANK 1"] call RYD_Mark;
		_i2 = [[_posXWP2,_posYWP2],_unitG,"markSFFlank2","ColorOrange","ICON","DOT","SF2 F"," - SF FLANK 2"] call RYD_Mark;
		_i3 = [[_posXWP3,_posYWP3],_unitG,"markSFFlank3","ColorOrange","ICON","DOT","SF3 F"," - SF FLANK 3"] call RYD_Mark;
		_i4 = [[_posXWP4,_posYWP4],_unitG,"markSFFlank4","ColorOrange","ICON","DOT","SF4 F"," - SF ATTACK"] call RYD_Mark
		};
