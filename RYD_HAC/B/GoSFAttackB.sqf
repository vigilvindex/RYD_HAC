...
if ((_ammo > 0) and not (_busy)) then
	...
	if ((RydHQB_Debug) or (isPlayer (leader _unitG))) then 
		{
		_i1 = [[_posXWP1,_posYWP1],_unitG,"markSFFlank1","ColorOrange","ICON","DOT","SF1 B"," - SF FLANK 1"] call RYD_Mark;
		_i2 = [[_posXWP2,_posYWP2],_unitG,"markSFFlank2","ColorOrange","ICON","DOT","SF2 B"," - SF FLANK 2"] call RYD_Mark;
		_i3 = [[_posXWP3,_posYWP3],_unitG,"markSFFlank3","ColorOrange","ICON","DOT","SF3 B"," - SF FLANK 3"] call RYD_Mark;
		_i4 = [[_posXWP4,_posYWP4],_unitG,"markSFFlank4","ColorOrange","ICON","DOT","SF4 B"," - SF ATTACK"] call RYD_Mark
		};
